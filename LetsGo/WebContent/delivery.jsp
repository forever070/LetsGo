            	...
            	<dt>
            		...
            		<i></i>
                	                ...
                	                <dd style="display: none;"><a href="collections.jsp">我收藏的职位</a></dd>
                	                	<dd style="display: none;"><a href="rmanage?op=queryByCid&uid=${loginname.id }">我投递的职位 <span id="noticeNo" class="red dn"></span></a></dd>
                	                	<dd class="btm" style="display: none;"><a href="subscribe.html">我的订阅</a></dd>
                	
                             <dd style="display: none;"><a href="accountBind.jsp">帐号设置</a></dd>
                              <dd class="logout" style="display: none;"><a rel="nofollow" href="register?op=kill">退出</a></dd>
            </dl>
            	...
            	<dl class="c_delivery">
                    ...
                    <dd>
                    	<div class="delivery_tabs">
                    		<ul class="reset">
                    			<li class="">
                    				<a href="rmanage?op=queryByCid&uid=${loginname.id }">全部</a>
                    			</li>
                    			<li>
                    				<a href="rmanage?op=queryByCid&uid=${loginname.id }&rstate=1">投递成功</a>
                    			</li>
                    			<li>
                    				<a href="rmanage?op=queryByCid&uid=${loginname.id }&rstate=2">被查看</a>
                    			</li>
                    			<li>
                    				<a href="rmanage?op=queryByCid&uid=${loginname.id }&rstate=3">通过初筛</a>
                    			</li>
                    			<li>
                    				<a href="rmanage?op=queryByCid&uid=${loginname.id }&rstate=4">通知面试</a>
                    			</li>
                    			<li class="last">
                    				<a href="rmanage?op=queryByCid&uid=${loginname.id }&rstate=5">不合适</a>
                    			</li>
                    		</ul>
                    	</div>
<!-- ********************************************************************** -->
                             		...
                             		<div class="d_item">
                             			 <h2 title="${r.pname }">
	                                        <a target="_blank" href="http://www.lagou.com/jobs/149594.html">
	                                        	<em>${r.pname }</em> 
	                                        	<span>${r.pfromsalary }</span>
	                                        	<!--  -->
	                                    	</a>
	                                    </h2>
	                                    		                                <div class="clear"></div>
	                                   	<a title="${r.cno }" class="d_jobname" target="_blank" href="http://www.lagou.com/c/25927.html">
	                                   		${r.cno } <span>[${r.ccity }]</span> 
	                                    </a>
	                                    <span class="d_time">${r.newdate }</span>
	                                    <div class="clear"></div>
	                                    <div class="d_resume">
	                                    	使用简历：
	                                    	<span>${r.rform }</span>
	                                    </div><a class="btn_showprogress" href="javascript:;">${r.rstate }<i></i></a></div>
                               			...
                               			<ul class="status_list">
                               				    <li class="top">
                               					<div class="list_time"><em></em>${r.newdate }</div>
                               					<div class="list_body">
                               					简历被标记为${r.rstate }<div></div>                               						                               					</div>
                               				</li>
                               				<li class="bottom">
                               					<div class="list_time"><em></em>${r.ddate }</div>
                               					<div class="list_body">
                               					${r.cno }已成功接收你的简历                               						                               					</div>
                               				</li>
                               				 </ul>
