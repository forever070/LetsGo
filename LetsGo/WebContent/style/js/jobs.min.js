...
//    		&& $('#salaryMax').val(''), $('#positionAddress').val() == $('#positionAddress').attr('placeholder') 
//    		&& $('#positionAddress').val(''),
    		a = $('#positionType').val(),
    		b = $('#positionName').val(),
    		c = $('#department').val(), 
...
//    	pid:q,
      ...
      dataType: 'json'
    	...
    	//alert(a)//
    	true==a?window.location.href = '/LetsGo/index06.jsp':alert('服务器繁忙，请稍后重试！！！')
