...
<dd style="display: none;"><a rel="nofollow" href="jianli.jsp">我的简历</a></dd>
                	                <dd style="display: none;"><a href="collections.jsp">我收藏的职位</a></dd>
                	                	<dd style="display: none;"><a href="rmanage?op=queryByCid&uid=${loginname.id }&rstate=1">我投递的职位 <span id="noticeNo" class="red dn"></span></a></dd>
                	<dd style="display: none;"><a href="index.jsp">我要找工作</a></dd>
    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dt>
                        <h1 title="产品经理">
                            <em></em>
                                                        	<div>${company.cname } ${position.company.cname }招聘</div>
                           	                           	${position.pname } ${company.position.pname }
                        </h1>
                    ...
                    <dd class="job_request">
                    	<span class="red">${position.pfromsalary }k-${position.ptosalary }k</span>
                       	<span>${position.pcity }</span> 
                       	<span>经验${position.pexperience }</span>
                       	<span> ${position.pdegree }</span> 
                       	<span>全职</span><br>
...
<p>3、每周定期举办足球、羽毛球、篮球及员工深度互动等文体活动。</p>
				                        ...
				                        <div>
								          <span> 你已有可投递的在线简历：<a title="${loginname.uname }的简历" target="_blank" href="jianli.jsp"><strong>${loginname.uname }的简历</strong></a></span><br>
								          <span>简历更新于2019-05-16 15:53</span>
				                        </div>
				                        <span class="setBtns">
				                        	<a target="_blank" title="预览" href="resume?op=queryByUid&uid=${loginname.id }">预览</a> |
                      	...
                      	<div class="dropdown_menu">
							<div class="drop_l">
								<img width="131" height="131" src="style/images/lagou01.jpg">
																<span>[仅限本人使用]</span>
															</div>
							<div class="drop_r">
                ...
                <dl class="job_company">
                    <dt>
                    	<a target="_blank" href="h/c/5004.html">
                            <img width="80" height="80" alt="科技有限公司" src="style/images/sex.jpg" class="b2">
                            <div>
                                <h2 class="fl">
                                	                                  		${position.company.cname }
                    ...
                    <dd>
                    	<ul class="c_feature reset">
                        	<li><span>领域</span> ${position.company.cfield }</li>
                        	<li><span>规模</span> ${position.company.clarge }</li>
                        	<li>
                        		<span>主页</span> 
                        		           							<a rel="nofollow" title="${position.company.csite }" target="_blank" href="${position.company.csite }">${position.company.csite }</a>
           						                        	</li>
                        </ul>
                        
                        <h4>发展阶段</h4>
                        <ul class="c_feature reset">
                        	<li><span>目前阶段</span> ${position.company.cdevelop }</li>
                        	                        </ul>
      ...
      <input type="hidden" id="userid" name="userid" value="${loginname.id }">
      <input type="hidden" id="resend_type" name="type" value="1">
      <input type="hidden" id="jobid" value="${position.pid }"><!-- c3c60c7111ae44baa145c562e0fa0af5 -->
      <input type="hidden" id="companyid" value="${position.company.cid }">/<!-- 83821246b3874e4b96117311cf7aaf23 -->
	        	...
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm">
	            		<label class="radio">
	            			...
	            			在线简历：
	            				            				<span title="jason的简历">${loginname }的简历</span>
	            				            		</label>
            			<div class="setBtns">
            					            				<a target="_blank" href="resume?op=queryByUid&uid=${loginname.id }">预览</a> |
	        	...
	        	<td>
                    <form class="resumeSetForm" id="resumeSendForm">
	            		<label class="radio">
	            			<input type="radio" value="1" class="resume1" name="resumeName">
	            			在线简历：
	            				            				<span title="jason的简历">${loginname.uname }的简历</span>
	            				            		</label>
            			<div class="setBtns">
            					            				<a target="_blank" href="resume?op=queryByUid&uid=${loginname.id }">预览</a> |
	            										<a target="_blank" href="jianli.jsp">修改</a>
        ...
        <table width="100%">
            ...
            <tr class="weixinQR">
            	<td>
            		<div class="weixin">
                       	<div class="qr">
                       		<img width="120" height="120" src="style/images/lagou01.png">
