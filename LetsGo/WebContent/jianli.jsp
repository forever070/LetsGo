	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
	    		...
	    		<li><a rel="nofollow" href="rmanage?op=queryByCid&uid=${loginname.id }">我投递的职位</a></li>
	    						    		</ul>
        	        	<dl class="collapsible_menu">
            	<dt>
           			<span id="spanuname">${loginname.uname }&nbsp;</span> 
            		<span class="red dn" id="noticeDot-0"></span>
            		<i></i>
            	</dt>
                <dd><a rel="nofollow" href="jianli.jsp">我的简历</a></dd>
<!--                 <dd><a href="collections.html">我收藏的职位</a></dd> -->
                <dd><a href="rmanage?op=queryByCid&uid=${loginname.id }&rstate=1">我投递的职位</a></dd> 
                <dd class="btm"><a href="subscribe.html">我的订阅</a></dd>
                <dd><a href="index.jsp">我要找工作</a></dd>
    ...
    <div id="container">
            ...
            <div class="content_l">
            	<div class="fl" id="resume_name">
	            	<div class="nameShow fl">
	            		<h1 title="jason的简历" >${loginname.uname }简历</h1>
	            		<span class="rename">重命名</span> | <a target="_blank" href="resume?op=queryByUid&uid=${loginname.id }">预览</a>
            		</div>
            		<form class="fl dn" id="resumeNameForm">
            			<input type="text" value="jason的简历" name="resumeName" class="nameEdit c9">	
            			<input type="submit" value="保存"> | <a target="_blank" href="resume?op=queryByUid&uid=${loginname.id }">预览</a>
            		</form>
            	</div><!--end #resume_name-->
        ...
        <!-- <div style="" class="scoreVal">
           				<span id="span">10</span>分
           			</div>  -->   			
           				<!-- <img alt="lagou" src="style/images/lgboy.jpg" width=218px height=154px > -->
            		</div>	
            	...
            	<div class="profile_box" id="basicInfo">
            		...
            		<div class="basicShow">
            			<span>${loginname.uname }    ${loginname.usex }    ${loginame.udegree }   ${loginname.uworkexp }<br>
            			          ${loginname.utel }  ${loginname.uaccount }<br>
            			</span>
            			<div class="m_portrait">
	                    	<div></div>
	                    	<img width="120" height="120" alt="cjh" src="style/images/coder.png">
	                    </div>
            		</div><!--end .basicShow-->
            			...
            			<form id="profileForm" >
						  <table>
						    <tbody><tr>
						      ...
						      <td>
						      	<input type="hidden" name="id" value="${loginname.id }"/>
						        <input type="text" placeholder="姓名" value="cjh" name="name" id="name">
						      </td>
						      <td valign="top"></td> 
						      <td>
						    ...
						    <tr>
						      ...
						      <td>
						      	<input type="hidden" id="topDegree" value="${loginname.udegree }" name="topDegree">
						      ...
						      <td>
						          <input type="hidden" id="workyear" value="${loginname.uworkexp }" name="workyear">
						    ...
						    <tr>
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="手机号码" value="${loginname.utel }" name="tel" id="tel">
						      </td>
						   	</tr>
						   	<tr>
						      <td valign="top">
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="接收面试通知的邮箱" value="${loginname.uaccount }" name="email" id="email">
						      </td>
						    </tr>
						    <tr>
						      <td valign="top"> </td> 
            		...
            		<input type="hidden" id="nameVal" value="${loginname.uname }">
            		<input type="hidden" id="genderVal" value="${loginname.usex }">
            		<input type="hidden" id="topDegreeVal" value="${loginname.udegree }">
            		<input type="hidden" id="workyearVal" value="${loginname.uworkexp }">
            		<input type="hidden" id="currentStateVal" value="">
            		<input type="hidden" id="emailVal" value="${loginname.uaccount }">
            		<input type="hidden" id="telVal" value="${loginname.utel }">
            	...
            	<div class="profile_box" id="workExperience">
            		...
            		<div class="experienceShow dn">
	            			...
	            			<input type="hidden" class="expId" value="${loginname.id }">
            	...
            	<div class="profile_box" id="projectExperience">
            		...
            		<div class="projectEdit dn">
            			<form class="projectForm">
			            	...
			            	<input type="hidden" value="${loginname.id }" class="projectId">
            	...
            	<div class="profile_box" id="educationalBackground">
            		...
            		<div class="educationalShow dn">
            		     <form class="educationalForm borderBtm dn">
	            			...
	            			<input type="hidden" class="eduId" value="${loginname.id }">
