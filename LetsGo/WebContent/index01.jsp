		...
		<div id="header">
			<div class="wrapper">
				...
				<ul id="navheader" class="reset">
					...
					<li><a rel="nofollow" href="">发布职位</a></li>
				</ul>
		...
		<div id="container">
			...
			<div class="content_mid">
				<dl class="c_section c_section_mid">
					...
					<dd>
						<form id="stepForm1" action="company?op=add" method="post">
							...
							<!-- <h3>公司全称 <span>福建平潭协创进出口贸易有限公司</span></h3> -->
								<input type="hidden"    value="${loginname.id }"
								name="uid" id="uid" class="valid">
							<h3>公司名称</h3>
							<!--非必填-->
							<input type="text" placeholder="请输入公司名称，如:拉勾" value=""
								name="cname" id="cname" class="valid">
	                   	...
	                   	<div class="c_logo c_logo_pos">
							...
							<h3>公司网址</h3>
							<input type="text" placeholder="请输入公司网址" value="" name="csite"
								id="csite">

							<h3>所在城市</h3>
							<input type="text" placeholder="请输入工作城市，如：北京" name="ccity"
								id="ccity">

							<h3>行业领域</h3>
							<input type="text" placeholder="请输公司领域，如：互联网" name="cfield"
								id="cfield">
							<!-- <div>
							...
							<h3>公司规模</h3>
							<input type="text" placeholder="请输公司规模，如：15-20人" name="clarge"
								id="clarge">
							<!--   <div>
							...
							<h3>发展阶段</h3>
							<input type="text" placeholder="请输入公司发展阶段，如：准备上市" name="cdevelop"
								id="cdevelop">
								<h3>投资机构</h3>
							<input type="text" placeholder="请输入公司投资机构" name="cinvest"
								id="cinvest">
	                    ...
	                    <div class="dn" id="cloneInvest">
							...
							<input type="text" placeholder="一句话概括公司亮点，如公司愿景、领导团队等，限50字"
								maxlength="50" name="cdescribe" id="cdescribe"> <span
								style="display: none;" class="error" id="beError"></span>
	                    ...
	                    <input type="hidden" id="companyName" name="companyName" value="福建平潭协创进出口贸易有限公司"> -->
							<input type="submit" value="保存"  class="btn_big fr">
						</form>
					</dd>
				</dl>
			</div>
