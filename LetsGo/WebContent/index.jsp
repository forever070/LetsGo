    ...
    <div id="container">
		...
		<div id="sidebar">
			<div class="mainNavs">
						...
						<div class="menu_main">
							<h2>技术 <span></span></h2>
				<a href="SearchList?spc=1&kd=PHP&labelWords=label">PHP</a>
				<a href="SearchList?spc=1&kd=C&labelWords=label">C</a>
				<a href="SearchList?spc=1&kd=C++&labelWords=label">C++</a>
				<a href="SearchList?spc=1&kd=Android&labelWords=label">Android</a>
				<a href="SearchList?spc=1&kd=IOS&labelWords=label">iOS</a>
				<a href="SearchList?spc=1&kd=前端开发&labelWords=label">前端开发</a>
				<a href="SearchList?spc=1&kd=测试&labelWords=label">测试</a>
				<a href="SearchList?spc=1&kd=技术经理&labelWords=label">技术经理</a>
				<a href="SearchList?spc=1&kd=项目经理&labelWords=label">项目经理</a>
				<a href="SearchList?spc=1&kd=架构师&labelWords=label">架构师</a>
			</div>
					   	<div class="menu_sub dn">
					   								    	<dl class="reset">
					        							        		<dt>
					        			<a href="SearchList?spc=1&kd=后端开发&labelWords=label">
					        									            								            							            								            							            								            							            								            							            								            							            								            						        				后端开发
					        			</a>
					        		</dt>
						        	<dd>
            ...
            <div id="hotList">
	            <ul class="hot_pos reset">
	            		            		            				            		<li class="clearfix">
		            																		            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="SearchList?spc=&kd=PHP&pl=&gj=&xl=&yx=&gx=&st=&labelWords=&lc=&workAddress=&city=" target="_blank">PHP</a> 
			                            &nbsp;
