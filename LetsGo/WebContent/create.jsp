...
<script type="text/javascript" src=""WebContent/style/js/jquery-1.11.3.min.js""></script>
				...
				<dl class="collapsible_menu">
           		...
           		<c:if test="${loginname.authority==1 }">
					...
					<dd style="display: none;">
						<a href="position?op=list">我发布的职位</a>
					</dd>
					<dd style="display: none;">
						<a href="rmanage?op=queryByCid&cid=${cid }&rstate=1">我收到的简历</a>
					</dd>
					...
					<dd class="logout" style="display: none;">
						<a rel="nofollow" href="register?op=kill">退出</a>
					</dd>
				</dl>
			</div>
		</div>
			...
			<div class="content">
				<dl class="company_center_content">
					...
					<dd>
						...
						<form  method="post"  id="jobForm"  action="#"  target="_self">
							<input type="hidden" value="" name="id"> <input
								type="hidden" value="create" name="preview"> <input
								type="hidden" value="${cid }" name="companyId"> <input
								...
								<tbody>
									...
									<tr>
										...
										<td><input type="text" placeholder="请输入工作城市，如：北京"
											value="" name="workAddress" id="workAddress"></td>
									</tr>
								</tbody>
							</table>
							...
							<table class="btm">
								<tbody>
									...
									<tr>
										...
										<input type="text"
											placeholder="描述工作职责" value=""
											name="positionDetail" class="tinymce"
											id="positionDetail"></td>
										<!-- <td><span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span>
								...
								<tbody>
									...
									<tr>
										...
										<input type="button" value="预览" id="jobPreview" class="btn_32"> 
											<input type="button" value="发布" id="formSubmit" class="btn_32"></td>
									</tr>
								</tbody>
							</table>
						</form>
