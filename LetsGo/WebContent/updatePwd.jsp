...
<input type="hidden" id="hasSidebar" value="1">	<div class="content user_modifyContent">
        <dl class="c_section">
            ...
            <dd>
            	  <form id="updatePswForm1" action="updatePwd?op=updatePwd" method="post">
            		<table class="savePassword">
            			<tbody><tr>
            				<td>登录邮箱</td>
            				<td class="c7">${loginname.uaccount } </td>
            			</tr>
            			<tr>
            				<td class="label">当前密码</td>
            				<td>
            					<input type="password" maxlength="16" id="oldpassword" value="111111" readonly="readonly" name="oldpassword" style="background-image: url(style/images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
...
<script type="text/javascript">
 $(document).ready(function() {
    	$('#updatePswForm1 input[type="text"]').focus(function(){
