       ...
       <li uid="${r.uid }" pid="${r.pid }" class="onlineResume">
             <label class="checkbox">
               ...
               <a title="预览在线简历" target="_blank" class="resumeImg" href="resume?op=queryByUid&uid=${r.uid }">
                   ...
                   <div class="links">
                      	<a data-deliverid="${r.uid }" cid="${cid }" pid="${r.pid }" data-name="${r.uname }" data-positionid="${r.pid }" data-email="${r.uaccount }" class="resume_notice" href="javascript:void(0)">通知面试</a>
