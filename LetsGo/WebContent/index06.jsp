	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
                ...
                <dd><a rel="nofollow" href="position?op=list">我发布的职位</a></dd>
                <dd><a href="rmanage?op=queryByCid&cid=${cid }&rstate=1">我收到的简历</a></dd>
                <dd class="btm"><a href="companylist.jsp">我的公司主页</a></dd>
            	...
            	<dl class="company_center_content">
	                ...
	                <dd> 
	                	...
	                	<div class="publish_tip">
                            <h2>恭喜你，职位发布成功！</h2>
                            <a target="_blank" href="position?op=list">预览职位</a><br>
                                                        <a class="greylink" href="create.jsp">继续发布新职位</a><br>
                                                        <a class="greylink" href="myhome.jsp"> 进入我的公司主页</a><br>
